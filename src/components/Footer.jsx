...
const Footer = () => {
  ...
  // Social icons (using inline SVGs for consistency)
  const socialLinks = [
    {
      name: 'Twitter',
      icon: (
  ...
  return (
    ...
    >
      ...
      <div style={{ height: '3px', background: 'linear-gradient(90deg, #6366f1, #8b5cf6, #06b6d4, transparent)', width: '100%' }} />
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="md:col-span-2">
            ...
            >
              Crafting digital spectra — innovative solutions that blend creativity, technology, and seamless user experiences.
            </motion.p>
            {/* Social Icons */}
            <motion.div
            ...
            >
              {socialLinks.map((social, idx) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 transition-all duration-200"
            ...
            <ul className="space-y-3 text-sm">
              {footerLinks.map(link => (
                <li key={link.path}>
                  <NavLink
                    to={link.path}
                    className="text-gray-500 hover:text-indigo-600 transition-colors duration-200 inline-flex items-center gap-1 group"
                  >
        ...
        >
          <p className="text-gray-400 text-xs tracking-wide">
            © {currentYear} SoftSpectrum. All rights reserved. Designed with <span style={{ color: '#ef4444' }}>❤️</span> for the digital frontier.
          </p>
        </motion.div>
      </div>
    </motion.footer>
